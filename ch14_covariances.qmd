...
```{r}
dataKline <- within(dataKline, {
  # create the corelation dataframe
...
#| fig-align: "center"
graph14_08 <- within(graph14_08, {
  # make sure you update the graph data
  # grf_tbl <- tidygraph::tbl_graph(
  #   nodes = dataKline$nodes_df,
  #   edges = dataKline$edges_df,
  #   directed = FALSE,
  #   node_key = "culture")
  # lyout <- ggraph::layout_tbl_graph_manual(graph = grf_tbl,
  #                                          x = lon2_pos,
  #                                          y = lat_pos)
  # p1 <- ggraph(grf_tbl, layout = lyout) +
  #   geom_node_point(aes(x = lon2_pos, y = lat_pos, color = logpop, size = logpop)) +
  #   # geom_edge_link(aes(color = cor)) +
  #   ggrepel::geom_text_repel(aes(x = lon2_pos, y = lat_pos, label = culture), size = 4) +
  #   scale_color_paletteer_c("pals::isol") +
  #   theme(legend.position = "none") +
  # labs(title = "Relative positions of societies",
  #      x = "longitude in thousands of km", y = "latitude in thousands of km")
