...
b6.6 <- xfun::cache_rds({brm(data = d, 
      family = gaussian,
      h1 ~ 0 + h0,
...
```{r ch06_b06_07}
tictoc::tic(msg = sprintf("run time of %s, use the cache.", "90 secs."))
b6.7 <- xfun::cache_rds({brm(data = d, 
      family = gaussian,
...
```{r ch06_b06_08}
tictoc::tic(msg = sprintf("run time of %s, use the cache.", "90 secs."))
b6.8 <- xfun::cache_rds({brm(data = d, 
      family = gaussian,
...
```{r ch06_b06_09}
tictoc::tic(msg = sprintf("run time of %s, use the cache.", "90 secs."))
b6.9 <- xfun::cache_rds({brm(data = d2, 
      family = gaussian,
      happiness ~ 0 + mid + A,
...
```{r ch06_b06_10}
tictoc::tic(msg = sprintf("run time of %s, use the cache.", "90 secs."))
b6.10 <- xfun::cache_rds({brm(data = d2,
      family = gaussian,
      happiness ~ 1 + A,
