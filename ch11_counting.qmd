...
# a_file <- here::here("fits", "b11_01.qs")
# b11.1 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_01b.qs")
# b11.1b <- qread(a_file)
...
3.  it allows us to use a single variable such as $treatment$ instead of creating separate prior for each when using `brms`. See what @kurtz2020b has to do in its version of chapter 8. The way Kurtz did it it render the `tidybayes` package less useful.
...
# a_file <- here::here("fits", "b11_02.qs")
# b11.2 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_03.qs")
# b11.3 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_04.qs")
# b11.4 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_06.qs")
# b11.6 <- qread(a_file)
# b11.6 <- brms::brm(
#   data = d.aggr,
#   family = binomial,
...
# a_file <- here::here("fits", "b11_07.qs")
# b11.7 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_08.qs")
# b11.8 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_09.qs")
# b11.9 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_10.qs")
# b11.10 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_11.qs")
# b11.11 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_12.qs")
# b11.12 <- qread(a_file)
...
a_file <- here::here("fits", "m11_13.qs")
m11.13 <- qread(a_file)
...
# a_file <- here::here("fits", "b11_13null.qs")
# b11.13null <- qread(a_file)
...
# a_file <- here::here("fits", "b11_13a.qs")
# b11.13a <- qread(a_file)
...
# qsave(b11.13a, a_file)

# a_file <- here::here("fits", "b11_13b.qs")
# b11.13b <- qread(a_file)
...
# qsave(b11.13b, a_file)


# a_file <- here::here("fits", "b11_13c.qs")
# b11.13c <- qread(a_file)
...
# qsave(b11.13c, a_file)


# a_file <- here::here("fits", "b11_13d.qs")
# b11.13d <- qread(a_file)
