...
This fit does not give the exact result obtained by McElreath. This is caused
by the fact that `brms` non-centered parametrization. See Kurtz in his sections
13.3.1 about that.
:::
