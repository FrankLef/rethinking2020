...
:::{.callout-tip}
## TODO
This `brm` command does not work. It was in @kurtz2020b. Section 5.3.2 and 6.2.1 are supposed to have the solution. We will come back.
:::
...
:::{.callout-warning}
The following code gives a warning about setting lower boundaries. It started
to show with `R 4.2`. Paul Buerkner advises to ignore it. See
[advice](https://discourse.mc-stan.org/t/error-with-gamma-prior/16420)
:::
...
We first create append the matrix to the data in one column. See @kurtz2020b on this data structure.
