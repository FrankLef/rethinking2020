...
```{r}
stop("TODO")
a_file <- here::here("fits", "b12_02a.qs")
b12.2a <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "m12_02a.qs")
m12.2a <- qread(a_file)
# m12.2a <- ulam(
#   data = dataKline,
#   flist = alist(
...
```{r}
a_file <- here::here("fits", "b12_02b.qs")
b12.2b <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "b12_03.qs")
b12.3 <- qread(a_file)
...
a_file <- here::here("fits", "b12_04.qs")
b12.4 <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "b12_05.qs")
b12.5 <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "b12_06.qs")
b12.6 <- qread(a_file)
