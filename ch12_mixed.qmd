...
$mean = \mu$ and $precision = \kappa$ to the shape (mathematical) 
...
the custom function `gammaGetMeanDispersion` is also defined. It is the inverse of `simstudy::gammaGetShapeRate()`.
