...
with family of parametrs. i.e.e parameter which are indexed. 
...
```{r}
post09_01b_trank <- posterior::as_draws_rvars(fit09_01b)
class(post09_01b_trank)
# unique(post09_01b_trank$.chain)
plot09_01b_trank <- bayesplot::mcmc_rank_overlay(x = post09_01b_trank, regex_pars = "is_africa") +
