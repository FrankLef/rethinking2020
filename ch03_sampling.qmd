...
Beside the base R `quantile` function, the `mean_qi` function from the
package `ggdist` will be used extensively in this project. The benefits of
using this package in conjonction with `posterior`, `tidybayes` etc. will
become obvious in later chapters.
